...
from aletheia_probe.retry_utils import async_retry_with_backoff, retry_with_backoff
...
class TestRetryWithBackoff:
    ...
    def test_exponential_backoff_timing(self):
        ...
        # Check that delays are roughly correct (allowing for timing variance)
        ...
        # Second delay should be ~0.2s (exponential_base=2.0)
    ...
    def test_max_delay_cap(self):
        ...
        # Check that the second delay is capped at max_delay
        # Third delay should be capped at 1.5s, not 5.0s
        time_diff_3 = call_times[3] - call_times[2]
        assert time_diff_3 < 1.7  # Should be ~1.5s, not ~5.0s
