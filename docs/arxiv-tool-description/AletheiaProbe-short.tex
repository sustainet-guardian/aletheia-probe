...
\Abstract{Researchers need to assess journal legitimacy when
  ...
  decisions. The tool integrates into research workflows through
  command-line and programmatic interfaces. It reduces manual assessment
  overhead from hours to minutes while explicitly flagging uncertain
  cases requiring human expertise. We present the tool's
...
established, and well-known journals through major search engines will
